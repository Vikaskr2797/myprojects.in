...
<head>
     ...
     <title>Dreamers Jobs - <?php echo "$jobtitle"; ?></title>
                                        ...
                                        <div class="tab-style-01">
                                             ...
                                             <ul class="nav" role="tablist">
                                                  <li role="presentation" class="active">
                                                       <h4><a href="#relatedJob1" role="tab" data-toggle="tab">More jobs
                                                                 from
                                                                 ...
                                                                 <a href="explore-job.php?jobid=<?php echo $row['job_id']; ?>"
										                            ...
										                            echo '<center><img class="autofit3" alt="image" title="'.$compname.'" width="180" height="100" src="data:image/jpeg;base64,'.base64_encode($complogo).'"/></center>';	
										                             ...
										                             ?>
                                                                           ...
                                                                           <div
                                                                                class="GridLex-col-3_sm-8-xs-8_xss-12 mt-10-xss">
                                                                           ...
                                                                           <div class="GridLex-col-3_sm-4_xs-4_xss-12">
                                                                                <?php echo "$sta"; ?>
                                                                                <span
                                                                                     class="font12 block spacing1 font400 text-center">
