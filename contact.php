...
<body class="not-transparent-header">
     ...
     <div class="container-wrapper">
          ...
          <div class="hero"
               style="background-image: url('images/hero-header/Contact-us-hero.png'); background-size: cover; background-position: center; background-repeat: no-repeat; height: 75vh; width: 100%;">
               <div class="container">
                         ...
                         <div class="row">
                              ...
                              <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                                   ...
                                   <div class="section-title">
                                        ...
                                        <h2 style="border:2px solid #2991a2;text-transform:capitalize;">
                                             Contact us📧</h2>
                         ...
                         <div class="row">
                              ...
                              <div class="col-sm-7 col-md-6 col-md-offset-1 mb-30">
                                   ...
                                   <form class="contact-form-wrapper" data-toggle="validator"
                                        action="https://formspree.io/f/xqazjdgw" method="POST" autocomplete="off">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <input id="inputName" name="fullname" type="text"
                                                            class="form-control" data-error="Your name is required"
                                                            required>
                                             ...
                                             <div class="col-sm-6">
                                                  ...
                                                  <div class="form-group">
                                                       ...
                                                       <input id="subject" name="subject" type="text"
                                                            class="form-control" data-error="Subject is required"
                                                            required>
                                                       <div class="help-block with-errors"></div>
                                                  </div>
                                             ...
                                             <div class="col-sm-6">
                                                  ...
                                                  <div class="form-group">
                                                       <label for="phone">Your Phone <span
                                                                 class="font10 text-danger">(*)</span></label>
                                             ...
                                             <div class="col-sm-12 text-right">
                                                  <button type="submit" class="btn btn-primary mt-5">Send
                                                       Message</button>
                                             </div>
                              ...
                              <div class="col-sm-5 col-md-4">
                                   ...
                                   <ul class="address-list">
                                        <li>
                                             <h5>Address</h5>
                                             <address> New delhi <br /> India <br />201301</address>
                                        </li>
                                        <li>
                                             <h5>Email</h5><a
                                                  href="mailto:connectwithus@dreamers.co.in">connectwithus@dreamers.co.in</a>
                                        </li>
                                        <li>
                                             <h5>Phone Number</h5><a href="tel:+91 7347851575">+91 7347851575</a>
                                        </li>
                                        ...
                                        <li>
                                             ...
                                             <div class="contact-social">
                                                  ...
                                                  <a href="<?php echo "$fb"; ?>" data-toggle="tooltip"
                                                       data-placement="top" title="Facebook"><i
                                                            class="fa fa-facebook"></i></a>
                                                  <a href="<?php echo "$tw"; ?>" data-toggle="tooltip"
                                                       data-placement="top" title="Twitter"><i
                                                            class="fa fa-twitter"></i></a>
                                                  <a href="<?php echo "$ig"; ?>" data-toggle="tooltip"
                         ...
                         <div class="container">
                              ...
                              <div class="row">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6 col-md-4">
                                                  ...
                                                  <div class="footer-about-us">
                                                       ...
                                                       <p>Dreamers Jobs is an online job portal and job management
                                                            system designed
                                                            to help people find employment more easily.</p>
                                   ...
                                   <div class="col-sm-12 col-md-3 mt-30-sm">
                                        ...
                                        <p><i class="fas fa-phone"></i> <a href="tel:+917347851575">+91 7347851575</a>
                                        </p>
