...
<head>
     ...
     <title>Dreamers Jobs - Employers</title>
                         ...
                         <div class="company-grid-wrapper top-company-2-wrapper">
							...
							?>
                                        <div class="GridLex-col-3_sm-4_xs-6_xss-12">
                                             ...
                                             <div class="top-company-2">
                                                  <a target="_blank"
                                                       href="company.php?ref=<?php echo $row['member_no']; ?>">
							...
							?>
                                                       ...
                                                       <div class="content">
                                                            ...
                                                            <p>
                                                            <p class="mata-p clearfix"><span
                                                                      class="text-primary font700">25</span>
                            ...
                            $total_records++;
	                        ...
	                        }catch(PDOException $e)
                             {
		                        ...
		                        ?><li class="paging-nav"><a
                                             ...
                                             href="employers.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a>
                                   </li><?php
                                 }	
