...
<head>
     ...
     <title>Dreamers Jobs - <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
                              ...
                              <div class="col-md-10 col-md-offset-1">
                                   ...
                                   <div class="employee-detail-wrapper">
										...
										?>
                                             ...
                                             <h2 class="heading mb-15"><?php echo "$myfname"; ?>
                                                  <?php echo "$mylname"; ?></h2>

                                             <p class="location"><i class="fa fa-map-marker"></i>
                                                  <?php echo "$mycountry"; ?>,
                                                  <?php echo "$mycity"; ?><span class="mh-5">|</span> <i
                                                       class="fa fa-phone"></i>
                                                  <?php echo "$myphone"; ?></p>
                                             ...
                                             <div class="row">
                                                ...
                                                ?>
                                                            <li>
                                                                 ...
                                                                 <p><a target="_blank"
                                                                           class="btn btn-primary btn-sm mb-5 mb-0-sm"
                                                ...
                                                ?>
                                                  <li>
                                                       ...
                                                       <p>Supervisor : <span class="font600 text-primary">
                                                                 <?php echo $row['supervisor']; ?></span> , Phone :
                                                            <span class="font600 text-primary">
                                             ...
                                             <ul class="employee-detail-list">
                                                ...
                                                ?>
                                                  <li>
                                                       ...
                                                       <p class="text-muted font-italic"><span
                                                                 class="font600 text-primary">
                                                                 <?php echo $row['institution']; ?></span>
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                             ...
                                             <div class="footer-about-us">
                                                  ...
                                                  <p>Dreamers Jobs is an online job portal and job management system
                                                       designed to
                    ...
                    <div class="container">
                         ...
                         <div class="row">
                              ...
                              <div class="col-sm-4 col-md-4">
                                   ...
                                   <p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Dreamers Vision
                                        Software</p>
